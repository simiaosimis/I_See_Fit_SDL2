...
# Lib settings
LIB_DIR := $(CURDIR)/lib
LINK_LIBS := -L$(LIB_DIR) -lm -ltmxparser -ltinyxml -lz

# Compiler
export LD := $(CXX)
# Compiler flags
CPPFLAGS= -O2 -g -W -Wall -pedantic -ansi -std=c++0x -Wextra -Wshadow -Wno-long-long
# Linking flags
LDFLAGS = -lSDL2 -lSDL2_ttf -lSDL2_image -lSDL2_mixer -lSDL2_ttf $(LINK_LIBS)
